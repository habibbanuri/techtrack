...
<body>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 px-24 items-center">
        <div class="-mt-4">
            <p
                ...
                Explore your career in <br class="lg:block hidden"><span
            ...
            <p class="my-16">
                ...
                exciting.
                <br>
                Join a community of like-minded professionals and gain insights from industry experts. Access exclusive
                resources to enhance your skills and stay ahead of the competition. Start your path to success with
                TechTrack Advisor today!
            </p>

            <!-- start button  -->
            <div class="flex gap-8">
                <a href="/#discover"
                    class="relative group overflow-hidden text-sm font-medium px-3 py-[10px] rounded-full flex space-x-2 items-center hover:border-2  hover:border-blue-600 border-2 border-blue-600">
                    <span class="relative text-sm text-blue-600  ">Learn More</span>
                    <div class="flex items-center -space-x-3 translate-x-3">
                        <div
                            class="w-2.5 h-[1.6px] rounded-sm bg-blue-600 origin-left scale-x-0 transition duration-300 group-hover:scale-x-100">
                        </div>
                        <svg xmlns="http://www.w3.org/2400/svg"
                            class="h-5 w-5 stroke-blue-600 -translate-x-2 transition duration-300 group-hover:translate-x-0"
    ...
    <div class="grid grid-cols-2 px-24 gap-10 mt-24 " id="discover">
        <div class="pr-36 my-auto">
            <p class="text-4xl font-bold">Create Your Personalized Tech
                Career Plan and Achieve Your
                Goals</p>
            <p class="mt-8">
                Our platform allows you to easily create a personalized plan based on your likes and career goals. With
                our interactive elements and algorithm-driven suggestions, you'll be on the right path to success.
            </p>
        </div>
    ...
    <div class="grid grid-cols-2 px-24 mt-28 gap-10">
        <div class="w-96">
            ...
            <p class=" text-blue-700 font-poppins">Discover</p>
            <p class="text-4xl font-bold">Explore the Best Local IT Companies and Boost Your Career</p>

        </div>

        <div>
            <p>TechTrack Advisor helps you discover local companies and opportunities that align with your career path.
                Explore a personalized tech career journey with us..</p>
            <div class="grid grid-cols-2 mt-12">
                <div>
                    <p class="font-bold text-blue-700 font-poppins">Assist</p>
                    <p>Discover local companies and job opportunities that match your career goals.</p>
                </div>
                <div>
                    <p class="font-bold text-blue-700 font-poppins">Align</p>
                    <p>Discover local companies and job opportunities that match your career goals.</p>
                </div>
            </div>
            <!-- start button  -->
    ...
    <section class="bg-[lightblue] relative bg">
        <div class="bg-cover bg-center my-24 h-[80vh] flex justify-center items-center"
            style="background-image: url('./images/newCouse.jpg')">
        </div>
        <p
            class="absolute top-[30%] left-[24%] cursor-pointer bg-gradient-to-r from-blue-600 to-cyan-500 h-[300px] w-[60%] rounded-3xl flex items-center justify-center text-xl">
            <span class="text-white pr-3 text-2xl">Now </span> Successfully Completed new Course and Still Waiting new
            Courses
        </p>
    ...
    <!-- start question  -->
    <div
        class='mt-10 px-24 flex justify-between items-center bg-gradient-to-r from-blue-600 to-cyan-500  text-white py-10 rounded-sm'>
        <div class="w-[30%]">
            <p class='text-[25px] font-bold'>Still have any question ?</p>
            <p class='text-[15px] py-8'> we're here to help! Reach out to our support team for personalized assistance
                and
